           ...
           <div className="absolute bottom-6 left-8 text-white z-10">
             <div className="flex items-center space-x-2 mb-3">
                <span className="px-3 py-1 bg-yellow-500 text-black text-xs font-black tracking-widest uppercase clip-button tech-font">
                    {item.category === 'education' ? '等级: 教育' : item.category === 'entertainment' ? '等级: 娱乐' : '等级: 工具'}
                </span>
                <span className="text-cyan-400 text-xs font-mono animate-pulse">● 系统就绪</span>
             </div>
        ...
        <div className="p-8 relative">
            ...
            <div className="flex flex-col md:flex-row gap-10">
                <div className="flex-1 z-10">
                    ...
                    <div className="mb-4">
                        <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">关键词</h4>
